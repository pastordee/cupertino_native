      ...
      child: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _buildMainSectionHeader('Custom Widget Examples', icon: CupertinoIcons.square_stack_3d_down_right),
            ...
            _buildExampleCard(
              ...
              description: 'Custom Flutter widgets with rich styling (gradient backgrounds)',
